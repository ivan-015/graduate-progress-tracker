 ...
 * @since 4/8/20
 * @version 1.0
 * Description: The purpose of this file is to serve as a function to modify internships in the sql table
 */
...
$sql = "UPDATE internships SET i_company='Aixa' WHERE u_id=8675309";
