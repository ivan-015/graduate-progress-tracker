 ...
 * @since 4/8/20
 * @version 1.0
 * Description: The purpose of this file is to serve as a function to modify awards in the sql table
 */
...
$sql = "UPDATE conferences SET c_name='GS - Engineering Essentials' WHERE u_id=8675309";
